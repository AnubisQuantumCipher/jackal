...
| `tests.package_unified_v173_test` after package-inventory wiring | exit 0; 10 tests, 5 expected skips without a fresh package root | package plan now copies and semantically binds `capability_inventory_v1.json`; pushed checkpoint `f6ffe749…` |
